...
from ENKA_CARD.character_card.utils import (
    fade_asset_icon,
    fade_character_art,
    format_statistics,
...
def generate_image(
    ...
    """ BACKGROUND SETUP """
    background = open_image(os.path.join(os.path.dirname(__file__), 'attributes', 'Assets', 'default_enka_card.png'))
    ...
    character_art = open_image(
        path=os.path.join(os.path.dirname(__file__), 'attributes', 'Genshin', 'Gacha', f'{character.image.banner.filename}.png'),
    ...
    character_shade = open_image(os.path.join(os.path.dirname(__file__), 'attributes', 'Assets', 'enka_character_shade.png'))
    ...
    friendship_icon = open_image(os.path.join(os.path.dirname(__file__), 'attributes', 'UI', 'COMPANIONSHIP.png'))
    ...
    c_overlay = open_image(os.path.join(os.path.dirname(__file__), 'attributes', 'Assets', 'enka_constellation_overlay.png'))
    ...
    lock = open_image(os.path.join(os.path.dirname(__file__), 'attributes', 'UI', 'LOCKED.png'), resize=(20, 25))
    ...
    for index, constellation in enumerate(character.constellations):
        ...
        constellation_icon = open_image(
            path=os.path.join(os.path.dirname(__file__), 'attributes', 'Genshin', 'UI', f'{constellation.icon.filename}.png'),
    ...
    """ Talents Section """
    talent_overlay = open_image(os.path.join(os.path.dirname(__file__), 'attributes', 'Assets', 'enka_talent_overlay.png'))
    ...
    for index, skill in enumerate(character.skills):
        ...
        sk = open_image(
            path=os.path.join(os.path.dirname(__file__), 'attributes', 'Genshin', 'UI', f'{skill.icon.filename}.png'),
    ...
    weapon_image = open_image(
        path=os.path.join(os.path.dirname(__file__), 'attributes', 'Genshin', 'Weapon', f'{weapon.detail.icon.filename}.png'),
    ...
    rarity_light = scale_image(
        open_image(
            os.path.join(os.path.dirname(__file__), 'attributes', 'UI', f'{RARITY_REFERENCE[str(weapon.detail.rarity)]}_WEAPON_LIGHT.png')
        ),
        fixed_height=40,
    )
    ...
    rarity = scale_image(
        open_image(
            os.path.join(os.path.dirname(__file__), 'attributes', 'UI', f'{RARITY_REFERENCE[str(weapon.detail.rarity)]}.png')
        ),
        fixed_height=25,
    )
    ...
    def draw_weapon_information(line_buffer: int = 0):
        ...
        image = open_image(os.path.join(os.path.dirname(__file__), 'attributes', 'UI', f'{get_stat_filename(mainstat.prop_id)}.png'))
        ...
        if substat:
            ...
            image = open_image(os.path.join(os.path.dirname(__file__), 'attributes', 'UI', f'{get_stat_filename(substat.prop_id)}.png'))
            icon_file = scale_image(image, fixed_height=30)
            icon_file = ImageEnhance.Brightness(icon_file).enhance(2)
    ...
    for index, item in enumerate(all_stats):
        """Draw Icon for Stat"""
        image = open_image(os.path.join(os.path.dirname(__file__), 'attributes', 'UI', f'{get_stat_filename(item)}.png'))
        icon_file = scale_image(image, fixed_height=30)
        icon_file = ImageEnhance.Brightness(icon_file).enhance(2)
    ...
    for artif_index, equipment_type in enumerate(positions):
        ...
        artif_icon = fade_asset_icon(
            open_image(
                path=os.path.join(os.path.dirname(__file__), 'attributes', 'Genshin', 'Artifact', f'{artifact.detail.icon.filename}.png'),
        ...
        image = open_image(os.path.join(os.path.dirname(__file__), 'attributes', 'UI', f'{get_stat_filename(artifact.detail.mainstats.prop_id)}.png'))
        icon_file = scale_image(image, fixed_height=30)
        icon_file = ImageEnhance.Brightness(icon_file).enhance(2)
        ...
        rarity = scale_image(
            open_image(
                os.path.join(os.path.dirname(__file__), 'attributes', 'UI', f'{RARITY_REFERENCE[str(artifact.detail.rarity)]}.png')
            ),
            fixed_height=18,
        )
        ...
        for index, subst in enumerate(artifact.detail.substats):
            ...
            image = open_image(os.path.join(os.path.dirname(__file__), 'attributes', 'UI', f'{get_stat_filename(subst.prop_id)}.png'))
            icon_file = scale_image(image, fixed_height=30)
            icon_file = ImageEnhance.Brightness(icon_file).enhance(2)
    ...
    flower_of_life = open_image(
        os.path.join(os.path.dirname(__file__), "attributes", "Assets", "flower_of_life_icon.png"), resize=(35, 35)
    )
